 ...
 */
public abstract class PictureFragment extends BaseFragment implements LoadFinishCallBack, LoadMoreListener, LoadResultCallBack {
    ...
    protected abstract PictureAdapter getAdapter();
