package com.rtfsc.rxjiandan.ui.view;
...
public class ShowMaxImageView extends ImageView {
    ...
    private void getHeight(Drawable drawable) {
        Rect bounds = drawable.getBounds();
        float bitmapWidth = bounds.width();
        float bitmapHeight = bounds.height();
